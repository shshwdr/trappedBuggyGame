...
namespace Lean.Touch
{
    ...
    public class LeanDragSelect : MonoBehaviour
    {
        ...
        public LineRenderer Prefab { set { prefab = value; } get { return prefab; } }
        [SerializeField] private LineRenderer prefab;

        /// <summary>The maximum amount of active trails.
        /// -1 = Unlimited.</summary>
        public int MaxTrails { set { maxTrails = value; } get { return maxTrails; } }
        ...
        public Color StartColor { set { startColor = value; } get { return startColor; } }
        [SerializeField] protected Color startColor = Color.white;

        /// <summary>The color of the trail end.</summary>
        public Color EndColor { set { endColor = value; } get { return endColor; } }
        ...
        void select(LineRenderer fingerData)
        {
            var positionCount = fingerData.positionCount;

            Vector3[] positions = new Vector3[positionCount];
            fingerData.GetPositions(positions);
            EventPool.Trigger<Vector3[]>("drawLine", positions);
